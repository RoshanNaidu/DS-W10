...
# in train.py, ensure it trains a scikit-learn linear regression model to predict the rating based on the single feature 100g_USD, also saves the trained model in this repository as a pickle file called model_1.pickle
import pandas as pd
